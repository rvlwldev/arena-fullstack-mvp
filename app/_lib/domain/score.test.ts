...
describe('computeResult', () => {
  ...
  it('각 진영 TOP3 정렬: score DESC, createdAt ASC', () => {
    const data: CommentVotes[] = [
      { commentId: 'a1', side: 'left', likes: 5, dislikes: 1, createdAt: ts(1) },
      { commentId: 'a2', side: 'left', likes: 10, dislikes: 0, createdAt: ts(5) },
      { commentId: 'a3', side: 'left', likes: 10, dislikes: 0, createdAt: ts(2) },
      { commentId: 'a4', side: 'left', likes: 3, dislikes: 0, createdAt: ts(3) },
      { commentId: 'b1', side: 'right', likes: 2, dislikes: 0, createdAt: ts(1) },
    ]
  ...
  it('승자 결정: 진영별 TOP3 점수 합 비교', () => {
    const data: CommentVotes[] = [
      { commentId: 'a1', side: 'left', likes: 10, dislikes: 0, createdAt: ts(1) },
      { commentId: 'a2', side: 'left', likes: 5, dislikes: 0, createdAt: ts(2) },
      { commentId: 'b1', side: 'right', likes: 20, dislikes: 0, createdAt: ts(1) },
    ]
    const r = computeResult(data)
  ...
  it('TOP3 합이 동률이면 TIE', () => {
    const data: CommentVotes[] = [
      { commentId: 'a1', side: 'left', likes: 5, dislikes: 0, createdAt: ts(1) },
      { commentId: 'b1', side: 'right', likes: 5, dislikes: 0, createdAt: ts(1) },
    ]
  ...
  it('음수 점수도 정상 계산되며 TOP3에 포함', () => {
    const data: CommentVotes[] = [
      { commentId: 'a1', side: 'left', likes: 0, dislikes: 3, createdAt: ts(1) },
      { commentId: 'a2', side: 'left', likes: 2, dislikes: 1, createdAt: ts(2) },
      { commentId: 'b1', side: 'right', likes: 0, dislikes: 0, createdAt: ts(1) },
    ]
    const r = computeResult(data)
